...
def set_environment_variables():
    ...
    os.environ["NVIDIA_API_KEY"] = "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" #set API key
...
def describe_image(image_content):
    ...
    if "choices" in response_json and len(response_json["choices"]) > 0:
        ...
        # Log an error and return a default message or handle it accordingly
        logging.error("The response does not contain 'choices' or is in an unexpected format.")
        return "Description not available for this image."
